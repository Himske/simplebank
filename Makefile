...
.PHONY: network postgres createdb dropdb migrateup migrateup1 migratedown migratedown1 sqlc_init sqlc_generate test server mock db_docs db_schema proto evans
